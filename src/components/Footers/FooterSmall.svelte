  ...
  <div class="container mx-auto px-4">
    ...
    <div class="flex flex-wrap items-center md:justify-between justify-center">
      <div class="w-full md:w-4/12 px-4">
        <div
          class="text-sm text-blueGray-500 font-semibold py-1 text-center md:text-left float-left"
        >
          Copyright © {date} &nbsp;
        </div>
        <div class="text-white hover:text-blueGray-300 text-sm font-semibold py-1 float-left">
