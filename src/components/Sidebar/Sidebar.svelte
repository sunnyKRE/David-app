...
>
  ...
  >
    ...
    <!-- Brand -->
    <img class="md:block text-left md:pb-2 text-blueGray-600 mr-0 inline-block whitespace-nowrap text-sm uppercase font-bold p-4 px-0" src ="http://www.kr-elec.co.kr/images/common/logo.png" alt="이미지를 표시할 수 없습니다." />
    <!-- User -->
      ...
      <ul class="md:flex-col md:min-w-full flex flex-col list-none md:mb-4">
        ...
        <li class="items-center">
          <a
                  ...
                  href="/admin/lookup"
          >
            <i class="fas fa-link text-blueGray-300 mr-2 text-sm"></i>
            수정
          </a>
        </li>
      </ul>
