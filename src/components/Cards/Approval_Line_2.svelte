...
<div style="display: flex; justify-content: space-between;  align-items: center; height:50px; transform: translate(0, 30%) ">
            ...
            {#each steps_TopSide as step_1, index }
                <div class="step__cover">
                    ...
                    {#if level_TopSide <= index}
                        {#if level_TopSide === index}
                            <div class="step__cover__circle_2">
                                <div class="step__cover__circle_2 waiting"></div>
                            </div>
                        {:else}
                            <div class="step__cover__circle_2"></div>
                        {/if}
                    {:else}
                        <div class="step__cover__circle_2 done"></div>
                    {/if}
                </div>
